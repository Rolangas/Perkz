...
const CTASection = () => {
  return (
    <section id="download" className="section py-20 md:py-32 relative overflow-hidden">
      {/* Background decorative elements - Fixed for iOS */}
      <div className="absolute top-20 left-10 w-40 h-40 bg-[rgba(59,130,246,0.05)] rounded-full blur-[60px] animate-pulse"></div>
      <div className="absolute bottom-20 right-10 w-40 h-40 bg-[rgba(168,85,247,0.05)] rounded-full blur-[60px] animate-pulse delay-1000"></div>
      
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="bg-[rgba(30,58,138,0.3)] backdrop-blur-md rounded-3xl p-8 md:p-12 border border-white/10 shadow-xl overflow-hidden relative">
          {/* Decorative circles - Fixed for iOS */}
          <div className="absolute -top-20 -right-20 w-40 h-40 bg-[rgba(59,130,246,0.1)] rounded-full blur-lg"></div>
          <div className="absolute -bottom-20 -left-20 w-40 h-40 bg-[rgba(168,85,247,0.1)] rounded-full blur-lg"></div>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            >
              <div className="aspect-square max-w-[300px] mx-auto bg-white p-6 rounded-2xl shadow-lg relative">
                ...
                {/* Decorative elements */}
                <div className="absolute w-20 h-20 bg-[rgba(59,130,246,0.1)] rounded-full blur-lg -top-10 -left-10"></div>
                <div className="absolute w-20 h-20 bg-[rgba(168,85,247,0.1)] rounded-full blur-lg -bottom-10 -right-10"></div>
              </div>
            </motion.div>
          </div>
        </div>
